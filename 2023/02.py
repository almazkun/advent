...
def get_game_draws(line: str) -> list:
    # Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green ->
    # ['6 red, 1 blue, 3 green', '2 blue, 1 red, 2 green']
    return line.split(":")[1].split(";")


def get_sets(draw: str) -> list:
    # '6 red, 1 blue, 3 green' -> ['6 red', '1 blue', '3 green']
    return [set.strip() for set in draw.split(",")]


def get_count_color(set):
    # '6 red' -> 6, 'red'
    return set.split(" ")[1], int(set.split(" ")[0])


def get_draw_sum(draw: str) -> dict:
    # '6 red, 1 blue, 3 green' -> {'red': 6, 'blue': 1, 'green': 3}
    sets = get_sets(draw)
    draw_sum = {"red": 0, "green": 0, "blue": 0}
    for set in sets:
        color, count = get_count_color(set)
        draw_sum[color] = count
    return draw_sum
...
def is_possible(line):
    ...
    for draw in draws:
        ...
        if (
            draw_sum["red"] > red
            or draw_sum["green"] > green
            or draw_sum["blue"] > blue
        ):
            return False
    return True
...
if __name__ == "__main__":
    inpt = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
    one_inpt = """Game 1: 1 blue, 1 red; 10 red; 8 red, 1 blue, 1 green; 1 green, 5 blue
